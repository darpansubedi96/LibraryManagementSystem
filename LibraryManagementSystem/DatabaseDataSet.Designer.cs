...
namespace LMS {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string name, string author, string category, int count) {
...
namespace LMS.DatabaseDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_count = 1 AND [count] IS NULL) OR ([count] = @Original_count)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([name], [author], [category], [count]) VALUES (@name, " +
                "@author, @category, @count);\r\nSELECT Id, name, author, category, count FROM Book" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [name] = @name, [author] = @author, [category] = @category, [count] = @count WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_count = 1 AND [count] IS NULL) OR ([count] = @Original_count)));
SELECT Id, name, author, category, count FROM Books WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LMS.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, author, category, count FROM dbo.Books";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_author, string Original_category, global::System.Nullable<int> Original_count) {
        ...
        public virtual int Insert(string name, string author, string category, global::System.Nullable<int> count) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string author, string category, global::System.Nullable<int> count, int Original_Id, string Original_name, string Original_author, string Original_category, global::System.Nullable<int> Original_count, int Id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string author, string category, global::System.Nullable<int> count, int Original_Id, string Original_name, string Original_author, string Original_category, global::System.Nullable<int> Original_count) {
            return this.Update(name, author, category, count, Original_Id, Original_name, Original_author, Original_category, Original_count, Original_Id);
        }
    }
